...
export function App() {
  ...
  return <div className="app-shell app-shell-p2">
    <aside className="sidebar"><a className="wordmark" href="#library" onClick={event => { event.preventDefault(); setPage('library'); }}><span className="brand-symbol">a.</span><span>题炼</span></a>
      ...
      <div className="sidebar-note"><span>专注，一道一道来。</span><p>题目与练习留在本机。<br />准备好内容后，离线也能继续。</p></div><div className="prototype-label">题炼 · 本机练习</div>
    </aside>
