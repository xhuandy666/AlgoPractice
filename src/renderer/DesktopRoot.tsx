...
export function DesktopRoot(){
  ...
  return <div className="interview-shell"><header className="interview-shell-header"><span className="wordmark"><span className="brand-symbol">a.</span>AlgoPractice</span><span>文本模拟面试 · 本机存储</span></header><InterviewWorkbench api={api!} sessionId={state} onLeave={()=>{sessionStorage.setItem('algo-page','interview');location.reload();}}/></div>;
}
