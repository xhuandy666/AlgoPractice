...
export interface InterviewItemView { item: InterviewItem; attempt: Attempt; draft: Draft | null; runs: StoredRun[]; aiHelp: {requestId: string; status: string; createdAt: string; finishedAt: string | null; duringSession: boolean}[]; recap: Draft | null; recapReasoning: string | null; }
